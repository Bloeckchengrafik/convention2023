...
class STLmodel:
    ...
    def load_stl(self):
        ...
        if self.filename:
            ...
            if type == 'solid':
                ...
                if len(self.triangles) < 1:
                    print
                    'ASCII load did not find any triangles.  Your binary .STL file probably starts with "solid". Trying a binary read instead'
        ...
        if len(self.triangles) < 1:
            print
            "No triangles found for file.  This may not be a .stl file."

    # read text stl match keywords to grab the points to build the model
    def load_text_stl(self):
        print
        "Attempting to read ASCII STL: " + str(self.filename)
    ...
    def load_binary_stl(self):
        print
        "Attempting to read binary STL: " + str(self.filename, )
        fp = open(self.filename, 'rb')
        h = fp.read(80)
    ...
    def write_text_stl(self, filename):
        ...
        try:
            ...
            print
            "Couldn't complete write. IOError encountered."
